...
**Main Findings**: Across 400 backtests spanning 5 symbols and 20 trading days (January 2017), OFI-integrated strategies achieve 37% loss reduction (72% win rate, $2,118 absolute improvement) compared to symmetric baselines with high statistical significance (p < 0.001, Cohen's d = 0.42). The improvement mechanism operates primarily through avoiding toxic fills (65% reduction in fill count: 772 → 274 fills/run) rather than optimizing individual fills.
...
| Microprice Only | -$3,355 | $6,439 | -0.521 | 772.7 | -11.0% | 40% |
| **OFI Ablation** | **-$1,234** | **$2,382** | **-0.518** | **273.9** | **+36.7%** | **72%** |
| **OFI Full** | **-$1,321** | **$2,509** | **-0.527** | **225.7** | **+65.5%*** | **70%** |

*OFI Full shows higher % due to variance but lower absolute improvement ($2,032 vs $2,118) and win rate (70% vs 72%) than OFI Ablation.
...
1. **Loss Reduction**: OFI Ablation achieves 36.7% smaller losses with 72% win rate
...
5. **Economic Interpretation**: Absolute losses are expected in academic simulations without exchange rebates (~$18/run) and sub-millisecond latency. The **$2,118 absolute improvement** validates OFI's effectiveness at reducing adverse selection.
...
1. **37% Loss Reduction, 72% Win Rate**: OFI Ablation shows dramatically smaller losses with $2,118 absolute improvement compared to symmetric baseline (p < 0.001, Cohen's d = 0.42)
